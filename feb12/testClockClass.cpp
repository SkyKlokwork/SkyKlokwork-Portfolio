...
int main()
{
    ...
    myClock.setTime(5, 4, 30, 9);                         //Line 1
    ...
    yourClock.setTime(5, 45, 16, -13);                      //Line 8
    ...
    cout << "Line 16: Enter the hours, minutes, sendods, and timezone: ";                               //Line 16
    cin >> hours >> minutes >> seconds >> timezone;                //Line 17
    cout << endl;                                      //Line 18

        //Set the time of myClock using the value of the
        //variables hours, minutes, and seconds
    myClock.setTime(hours, minutes, seconds, timezone);          //Line 19
    ...
    cout << endl;                                      //Line 26
        ...
        //object myClock
    myClock.getTime(hours, minutes, seconds, timezone);          //Line 27

        //Output the value of hours, minutes, and seconds
    cout << "Line 28: hours = " << hours 
         << ", minutes = " << minutes 
         << ", seconds = " << seconds << 
         ", UTC = " << timezone << endl;         //Line 28
